...
- *Daily Estuary Salinity Report*
    - [Report](http://publicfiles.dep.state.fl.us/owp/SalinityReports/SalinityUpdate.html){target="_blank"} 
    - [*Source*](https://github.com/owper-tech/owper-EstuarySalinityUpdate){target="_blank"}

- *Daily Everglades Water Level Report*
    - [Report](http://publicfiles.dep.state.fl.us/owp/SalinityReports/WaterLevelUpdate.html){target="_blank"} 
    - [*Source*](https://github.com/owper-tech/owper-WaterLevelUpdate){target="_blank"}
    
- *Daily System Report Tables*
    - [Report](http://publicfiles.dep.state.fl.us/owp/SalinityReports/DailySystemReport_Table.html){target="_blank"}
    - [*Source*](https://github.com/owper-tech/owper-SystemReport){target="_blank"}
...
- **LOSOM**
    ...
    - DRAFT - Estuary Nutrient Loading Model (Caloosahatchee Estuary) [link](https://swampthingecology.org/slides/LOSOMWQ/Julian_LOSOM_ENLM#1){target="_blank"}


- **BBSEER**
  
    - Project Specific OFW and NNC information [link](https://swampthingecology.org/slides/BBSEER/BBSEER_OFW_map.html){target="_blank"}
