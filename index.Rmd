...
- *Daily Estuary Salinity Report*
    - [Report](http://publicfiles.dep.state.fl.us/owp/SalinityReports/SalinityUpdate.html){target="_blank"} *Source*

- *Daily Everglades Water Level Report*
    - [Report](http://publicfiles.dep.state.fl.us/owp/SalinityReports/WaterLevelUpdate.html){target="_blank"} *Source*
    
- *Daily System Report Tables*
    - [Report](http://publicfiles.dep.state.fl.us/owp/SalinityReports/DailySystemReport_Table.html){target="_blank"} *Source*
...
## Respositories
 ...
 - [github.com/owper-tech](https://https://github.com/owper-tech/){target="_blank"}: Github organization
